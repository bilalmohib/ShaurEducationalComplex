...
function go()
{
    ...
    {
        location.href = "ShowScore.html";//jo hum ne page banya ha store krne k bad wahn pe ye target kra ha ha
    }
    else
    {
        alert("Please Select the class and Subject to See Data");
    }
}